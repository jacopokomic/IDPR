...
# ---------------------------------------------------------------------------------------------- elementi
        ...
        self.nastavek_partikularna1 = man.MathTex("x_\\mathrm{p}").move_to([-4.95, 1.5, 0])
        ...
        self.staticni_faktor_def = man.MathTex("X_0 = \\frac{f_0}{\\omega_0^2}").scale(0.7).set_opacity(0.4).move_to([-4.15, -3, 0])
        self.dinamicni_faktor_def = man.MathTex("\\beta = \\sqrt{\\frac{1}{(1 - r^2)^2 + (2 \\delta r)^2}}").set_opacity(0.4).scale(0.7).move_to([-1, -3, 0])
...
# ---------------------------------------------------------------------------------------------- prikaz animacij
        ...
        self.wait()
        self.play(self.vsota_sil.animate.shift(man.LEFT*1.9), self.ma.animate.shift(man.LEFT*1.9), self.enacaj3.animate.shift(man.LEFT*1.9))
        ...
        self.wait()
        self.play(man.FadeIn(self.smer_x))
        self.wait()
        ...
        self.wait()
        self.play(man.FadeOut(self.smer_x))
        self.wait()
        ...
        self.wait()
        self.play(self.razmernik_frekvenc_def.animate.move_to([-6, -3, 0]))
        ...
        self.wait()
        self.play(self.partikularna_def.animate.move_to([-3, 1.5, 0]), self.X_def.animate.move_to([-3, 0, 0]), self.tan_phi_def.animate.move_to([-3, -1.5, 0]))
        self.wait()
