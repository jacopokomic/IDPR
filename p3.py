...
# ---------------------------------------------------------------------------------------------- elementi
        ...
        self.sin_omega_t = man.MathTex("sin(\\omega t)").scale(0.5).rotate((1/4) * man.PI).move_to([5.5, 1.75, 0])
        ...
        self.cos_omega_t = man.MathTex("cos(\\omega t)").scale(0.5).rotate(-(1/4) * man.PI).move_to([2.5, 1.75, 0])
        ...
        self.Fv = man.MathTex("F_v", color = man.RED).next_to(self.sila_vzmeti.get_end(), man.DOWN, buff = 0.1)
        self.Fd = man.MathTex("F_d", color = man.RED).next_to(self.sila_dusilke.get_end(), man.DOWN, buff = 0.1)
...
# ---------------------------------------------------------------------------------------------- prikaz animacij
        ...
        self.wait()
        self.play(man.GrowArrow(self.kazalec2), man.Create(self.pravi_kot))
        self.play(man.GrowFromPoint(self.smer_cos, self.kazalec2.get_end()))
        self.play(man.Write(self.cos_omega_t))
        self.wait()
        self.play(man.FadeOut(self.kazalec2, self.pravi_kot, self.smer_sin, self.sin_omega_t, self.smer_cos, self.cos_omega_t))
        self.wait()
        ...
        self.wait()
        self.play(self.gor.animate.shift(man.UP*0.5), man.Transform(self.vzmet, self.vzmet_raztegnjena), rate_func = man.rush_from)
        self.wait()
        self.play(man.FadeOut(self.vzmet, self.k, self.dusilka_prej, self.d), man.GrowArrow(self.sila_vzmeti), man.GrowArrow(self.sila_dusilke))
        self.play(man.Write(self.Fv))
        self.play(man.Write(self.Fd))
        self.wait()
        self.play(man.Write(self.IINZ))
        self.play(man.Write(self.enacba_prej))
        #self.wait(man.Transform(self.enacba_prej, self.enacba_potem))
        self.wait()
