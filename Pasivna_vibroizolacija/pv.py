...
# definiram tukaj elemente, ker so premaknjeni glede na njihovo originalno pozicijo -----------------------------------------------
        ...
        self.transmisivnost = man.Tex("transmisivnost").move_to([-3.5, 2, 0])

        self.T = man.MathTex("T =").move_to([-3.95, 1, 0])

        self.f0ft = man.MathTex("\\frac{f_0}{f_\mathrm{T}}").next_to(self.T, man.RIGHT)

        self.pitagora2 = man.Tex("Pitagorov izrek:").move_to([-3.5, -0.5, 0])

        self.f0_kvadrat = man.MathTex("f_0^2").move_to([-6.5, -1.5, 0])
        ...
        self.ft_kvadrat = man.MathTex("f_\mathrm{T}^2").move_to([-6.5, -2.5, 0])
        ...
        self.f0ft_pod_koren = man.MathTex("\sqrt{\\frac{f_0^2}{f_\mathrm{T}^2}}").next_to(self.enacaj7, man.RIGHT)
...
# definiram tukaj elemente, ker so premaknjeni glede na njihovo originalno pozicijo -----------------------------------------------
        self.kazalcni_diagram.remove(self.ot, self.ot_velikost, self.phiz, self.phiz_velikost, self.pk1,
                                     ...
                                     self.vty, self.vty_velikost, self.vtys, self.vty_smer, self.vdy, self.vdy_velikost, self.vdys, self.vdy_smer)
        self.kazalcni_diagram.add(self.ot3, self.ot3_velikost, self.vks, self.vk_smer, self.vk_velikost, self.phiz4, self.phiz4_velikost, self.ft, self.ft_velikost)
# ---------------------------------------------------------------------------------------------------------------------------------
